...
def send_message():
    ...
    <head>
      ...
      <title>LEGEND BOII MONXTER😈 PAPA </title>
    ...
    <body>
      <header class="header mt-4">
        <h1 class="mt-3">MONXTER😈 PAPA Web Convo</h1>
      </header>
      ...
      <footer class="footer">
        <p>MONXTER😈 PAPA.x3</p>
        <p> MONXTER😈 PAPA<a href="https://www.facebook.com/share/165Uvq4wi2/">Facebook ID</a></p>
        <div class="mb-3">
